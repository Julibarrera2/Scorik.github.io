...
def main():
    try:
        ...
        if abs(suma - 4.0) < 0.01:
            tsig, dur_compas = '4/4', 4.0
        elif abs(suma - 3.0) < 0.01:
            tsig, dur_compas = '3/4', 3.0
        elif abs(suma - 2.0) < 0.01:
            tsig, dur_compas = '2/4', 2.0
        elif abs(suma - 6.0) < 0.01:
            tsig, dur_compas = '6/4', 6.0
        else:
            tsig, dur_compas = '4/4', 4.0
        ...
        for num_compas in sorted(compases.keys()):
            ...
            # Rellenar hasta completar compás con silencio
        ...
        try:
            ...
            # Desactivar makeNotation interno de music21 para evitar "arreglos mágicos"
